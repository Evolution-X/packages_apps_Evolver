...
public class PowerMenuActions extends SettingsPreferenceFragment {
    ...
    private static final String RESTART_ACTIONS_SETTING = "power_menu_restart_actions";
    ...
    public void onStart() {
        ...
        // Show warning on fastboot/download prefs if bootloader is locked
        boolean bootloaderLocked = "1".equals(SystemProperties.get("ro.boot.flash.locked", "1"));
        if (mRestartFastbootPref != null) {
            mRestartFastbootPref.setSummary(bootloaderLocked
                    ? R.string.restart_fastboot_locked_warning : 0);
        }
        if (mRestartDownloadPref != null) {
            mRestartDownloadPref.setSummary(bootloaderLocked
                    ? R.string.restart_download_locked_warning : 0);
        }
