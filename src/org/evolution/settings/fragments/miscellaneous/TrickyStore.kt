...
class TrickyStore : SettingsPreferenceFragment() {
    ...
    private fun refreshStatus() {
        ...
        findPreference<Preference>("ts_verification_mode")?.summary = when (readCurrentMode()) {
            "cert" -> getString(R.string.ts_verification_mode_cert)
            "leaf" -> getString(R.string.ts_verification_mode_leaf)
