            ...
            try {
                ...
                for (version in versions) {
                    try {
                        ...
                        // Supplemental fallback names for codenames not yet in
                        // PixelDeviceRepository.DEVICE_MODEL_MAP. Update alongside
                        // that map when new Pixel generations are added.
                        val supplementalModelNames = mapOf(
                            "silverback" to "Pixel 9 Pro Fold",
                            "kodiak"     to "Pixel 10 Pro XL",
                            "blazer"     to "Pixel 10 Pro Fold",
                            "frankel"    to "Pixel 10 Pro",
                            "mustang"    to "Pixel 10",
                        )
